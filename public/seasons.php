...
<html lang="en-US">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo CUSTOM_CSS."seasons.css?v=".filemtime(CUSTOM_CSS."seasons.css"); ?>" />
    <noscript>
  ...
  <body>
      ...
      <div class="column columnm columnmb column3" style="z-index:5;background-color:inherit;">
        <div class="item fixer-item-mhw">
          <div class="scrollar-masthead" data-scrollar-speed="0.2">
            <div class="word word-one"><span>Sea</span></div>
          </div>
        </div>
        <div class="item fixer-item-mhbg fixer-item-mhbg-1">
          <img class="scrollar-masthead" data-scrollar-speed="0.4" src="./lib/img/spaceship-pod-dark.jpg" />
        </div>
      </div>
      <div class="column columnm columnmb column4">
        <div class="item fixer-item-mhw">
          <div class="scrollar-masthead" data-scrollar-speed="-0.2">
            <div class="word word-two"><span>sons</span></div>
          </div>
        </div>
        <div class="item fixer-item-mhbg fixer-item-mhbg-2">
          <img class="scrollar-masthead" data-scrollar-speed="-0.4" src="./lib/img/sky-night-house.jpg" />
        </div>
      </div>
    ...
    <script type="text/javascript" src="<?php echo CUSTOM_JS."seasons.js?v=".filemtime(CUSTOM_JS."seasons.js"); ?>"></script>
  </body>
